...
nuts_and_bolts_model.load_weights("../models/nuts_and_bolts_dl.h5")
...
image = cv2.imread('/home/senthil/Personal/workshop/ahws_17/examples/data/nuts_n_bolts_master/all_dl/test/bolts/0062.jpg')
resized_image = cv2.resize(image, (50,65)).reshape(1,50,65,3)
print(nuts_and_bolts_model.predict(resized_image))

#nuts_and_bolts_model = cv2.dnn.readNetFromTensorflow('../models/my_model.pb')
